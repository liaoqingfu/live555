...
void GenericMediaServer::addServerMediaSession(ServerMediaSession* serverMediaSession)
{
    if (serverMediaSession == NULL) {
        envir() << "lcp-debug GenericMediaServer::addServerMediaSession serverMediaSession is NULL !!!!\n";
        return;
    }
...
void GenericMediaServer::ClientConnection::incomingRequestHandler()
{
    ...
    envir() << "lcp-debug GenericMediaServer::ClientConnection::incomingRequestHandler() handleRequestBytes(" << bytesRead << ")---------\n";
